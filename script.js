...
function createPlayer() {
    $(".game").append('<div class="player" id="player"><img src="https://github.com/DzarelDeveloper/Img/blob/main/bluebird-midflap.png?raw=true"></div>')
    player = $("#player");
}
...
function audio(name) {
    ...
    switch(name) {
        case "die":
            a = "https://github.com/DzarelDeveloper/Img/raw/main/assets_audio_sfx_die.wav"
            break;
        case "hit":
            a = "https://github.com/DzarelDeveloper/Img/blob/main/assets_audio_sfx_hit.wav"
            break;
        case "point":
            a = "https://github.com/DzarelDeveloper/Img/raw/main/assets_audio_sfx_point.wav"
            break;
        case "jump":
            a = "https://github.com/DzarelDeveloper/Img/raw/main/assets_audio_sfx_wing.wav"
            break;
    }
    a = new Audio(a);
    a.loop = false;
